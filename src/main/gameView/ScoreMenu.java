...
import main.gameModel.GameFrame;
...
/**
 * This class displays the score menu.
 */
public class ScoreMenu extends JComponent implements MouseListener, MouseMotionListener {

    private static final String BACK_TEXT = "Back";
    private static final String INSTRUCTIONS = "Scoreboard";
    private static final String INSTRUCTIONS1 = "1st place: 189";
    private static final String INSTRUCTIONS2 = "2nd place: 162";
    private static final String INSTRUCTIONS3 = "3rd place: 155";
    ...
    private Image image = t.getImage("src/main/resources/image3.jpg");
    ...
    /**
     * This method sets the location of the score menu, the button size, fonts.
     * @param owner reads the input the owner of the system.
     * @param area passing in the area of the menu.
     */
    public ScoreMenu(GameFrame owner,Dimension area){
